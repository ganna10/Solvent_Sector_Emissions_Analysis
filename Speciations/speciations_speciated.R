...
mcm.data = read.csv(file = "/local/home/coates/Documents/LaTeX/Presentations/2015_Mar_PAC/Plotting_scripts/Speciations_Speciated_for_MCM.csv", header = TRUE)
...
mozart.data = read.csv(file = "/local/home/coates/Documents/LaTeX/Presentations/2015_Mar_PAC/Plotting_scripts/Speciations_Speciated_for_MOZART.csv", header = TRUE)
...
radm2.data = read.csv(file = "/local/home/coates/Documents/LaTeX/Presentations/2015_Mar_PAC/Plotting_scripts/Speciations_Speciated_for_RADM2.csv", header = TRUE)

...
sub get_category {
    ...
    if ($process =~ /CO \+ OH/) {
        ...
        $category = "Aldehydes";
    } elsif ($process eq "OLI" or $process =~ /C5H8|ISO|BIGENE|BUT1ENE|C2H2/) {

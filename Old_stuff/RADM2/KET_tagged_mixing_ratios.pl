#! /usr/bin/env perl
# Compare KET mixing ratios as emitted species and degradation product in EMEP Solvents Only run
...
my $dir = "/local/home/coates/Solvent_Emissions/RADM2/EMEP_tagged_solvents_only";
...
$R->run(q` CairoPDF(file = "KET_tagged_mixing_ratio_comparison.pdf") `,
        q` print(plot) `,
        q` dev.off() `,
);
